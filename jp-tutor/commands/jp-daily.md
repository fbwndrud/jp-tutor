...
복습 항목이 5개 이상이면, 퀴즈 전에 **워밍업 미니게임 1판**을 먼저 진행합니다:
1. 복습 항목으로 매칭카드/스네이크매치 등 가벼운 게임 1판 생성 (recognition 위주)
2. 게임으로 기억을 활성화한 뒤 퀴즈로 넘어감
...
3. **미니게임으로 연습** — 신규 개념 3개 이상이면 가벼운 게임 1판으로 연습:
   - 새 어휘 → 매칭카드 또는 셔플퍼즐
   - 새 문법 → 조사 빈칸 또는 셔플퍼즐
   - 새 한자 → 부수 조립 또는 매칭카드
   - 게임 티어는 1(입문)로 고정
